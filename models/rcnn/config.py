...
# '/path/to/your/TRAIN/TFRECORD'
# '/scratch_net/biwidl104/jendelel/transformed_eval_inbreast_test_zrh_rcnn/train.tfrecord'
_C.DATA.TRAIN_PATTERN = '/scratch_net/biwidl104/jendelel/cbis_bcdr_augmented/train.tfrecord'
# '/path/to/your/VAL/TFRECORD'
# _C.DATA.VAL_PATTERN = '/scratch_net/biwidl104/jendelel/inbreast_eval_gen_rcnn/eval.tfrecord'
_C.DATA.VAL_PATTERN = '/scratch_net/biwidl104/jendelel/inbreast_eval_gen_rcnn/eval.tfrecord'
_C.DATA.TEST_PATTERN = '/scratch_net/biwidl104/jendelel/inbreast_eval_gen_rcnn/test.tfrecord'
...
# _C.DATA.VAL = 'val2014' # 'minival2014'  # AKA val2017
...
_C.DATA.CLASS_NAMES = ['BG', 'BENIGN', 'MALIGNANT']

_C.BREASTS.MALIGNANT_CONFIDENCE = 0.23
_C.BREASTS.CALC_FOOLING_STATS = True
...
_C.TRAIN.EVAL_PERIOD = 5  # period (epochs) to run eval

# preprocessing --------------------
# Alternative old (worse & faster) setting: 600, 1024
_C.PREPROC.TRAIN_SHORT_EDGE_SIZE = [408, 408]  # [min, max] to sample from
_C.PREPROC.TEST_SHORT_EDGE_SIZE = 408
...
_C.RPN.MIN_SIZE = 0
_C.RPN.PROPOSAL_NMS_THRESH = 0.5
_C.RPN.CROWD_OVERLAP_THRESH = 0.5  # boxes overlapping crowd will be ignored.
