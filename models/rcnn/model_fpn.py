...
from tensorpack.models import (Conv2D, layer_register, FixedUnPooling, MaxPooling)

from models.rcnn.model_rpn import rpn_losses, generate_rpn_proposals
from models.rcnn.model_box import roi_align
from models.rcnn.utils.box_ops import area as tf_area
...
@under_name_scope()
def generate_fpn_proposals(multilevel_anchors, multilevel_label_logits, multilevel_box_logits, image_shape2d):
    """
    Args:
        multilevel_anchors: #lvl RPNAnchors
        multilevel_label_logits: #lvl tensors of shape HxWxA
        ...
        for lvl in range(num_lvl):
            with tf.name_scope('Lvl{}'.format(lvl + 2)):
                ...
                proposal_boxes, proposal_scores = generate_rpn_proposals(
                        tf.reshape(pred_boxes_decoded, [-1, 4]), tf.reshape(multilevel_label_logits[lvl], [-1]),
